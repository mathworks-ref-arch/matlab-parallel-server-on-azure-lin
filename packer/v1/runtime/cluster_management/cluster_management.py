...
def main() -> int:
    ...
    # The custom_dns_suffix variable contains the custom DNS search suffix used to identify worker nodes
    custom_dns_suffix = cluster_management_interface.cluster_management_config[
        CUSTOM_DNS_SUFFIX
    ]

    # The use_private_ip_mapping boolean variable determines whether private IP addresses should be used
